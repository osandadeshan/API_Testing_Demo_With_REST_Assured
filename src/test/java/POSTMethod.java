...
public class POSTMethod extends BaseClass{
	...
	public void responseForLoginApiForNullPassword(String username) throws IOException {
		String JsonPayloadForLogin = JsonRequestsCreator.setJsonBodyForInvalidLoginRequestUsingNullPassword(username);
		// Executing API and getting the response
		postAPI(JsonPayloadForLogin);
	}
	...
	public void responseForLoginApiForNullUsername(String password) throws IOException {
		String JsonPayloadForLogin = JsonRequestsCreator.setJsonBodyForInvalidLoginRequestUsingNullUsername(password);
		// Executing API and getting the response
		postAPI(JsonPayloadForLogin);
	}
	...
	public void responseForLoginApiForNullUsernameNullPassword() throws IOException {
		String JsonPayloadForLogin = JsonRequestsCreator.setJsonBodyForInvalidLoginRequestUsingNullUsernameNullPassword();
		// Executing API and getting the response
		postAPI(JsonPayloadForLogin);
	}
